    ...
    <div className="name-wrap w-4/5 lg:w-6/12 md:w-2/3 text-center mx-auto mt-3 md:mt-5">
      <div className="flex justify-end">
        <div className="text-white">
          <Link
            to={"/en-US/" + location.pathname.split("/")[2]}
            className={
              "rounded-full inline-flex items-center justify-center cursor-pointer mr-2 border-2 h-8 w-8 transition-colors duration-500 ease-in-out hover:bg-purple-900 " +
              (i18n.language === "en-US" ? "bg-indigo-900" : "")
            }
            onClick={() =>
              i18n.language !== "en-US" && i18n.changeLanguage("en-US")
            }
          >
            en
          </Link>
          <Link
            to={"/pt-BR/" + location.pathname.split("/")[2]}
            className={
              "rounded-full inline-flex items-center justify-center cursor-pointer border-2 h-8 w-8 transition-colors duration-500 ease-in-out hover:bg-purple-900 " +
              (i18n.language === "pt-BR" ? "bg-indigo-900" : "")
            }
            onClick={() =>
              i18n.language !== "pt-BR" && i18n.changeLanguage("pt-BR")
            }
          >
            pt
          </Link>
